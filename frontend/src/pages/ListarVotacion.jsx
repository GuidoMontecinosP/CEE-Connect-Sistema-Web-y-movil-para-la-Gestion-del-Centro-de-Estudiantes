...
import { Layout, Card, Button, Typography, Space, Row, Col, Tag, Spin, message, Divider, Radio, Badge, Menu, Breadcrumb } from 'antd';
...
function ListarVotaciones() {
  ...
  return (
    <MainLayout breadcrumb={<Breadcrumb style={{ margin: '14px 0' }} items={[{ title: 'Votaciones' }]} /> }>
